...
class Tree:
    ...
    def belief_update(ddn: DecisionNetwork, b: pd.DataFrame, a: int, o: int):
        ...
        snid = ddn.get_nodes_by_key(lambda nid, n: (isinstance(n, StateNode) and (not ddn.is_root(nid))))[0]
        ...
        r = ddn.query(query=[snid], evidence={onid: o})
        return r
    ...
    def pomdp_lookahead(self, ddn: DecisionNetwork):
